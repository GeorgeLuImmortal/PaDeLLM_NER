...
if __name__ == "__main__":
    ...
    with open(f'/mnt/bn/lujinghui-nas-lq/NER_dsot_inference/run_cn_scripts/{dataset}/{dataset}_{model_size}_{identifier}_dedu.json', 'r') as fin:
    ...
    json.dump(test_data, open(f'/mnt/bn/lujinghui-nas-lq/NER_dsot_inference/run_cn_scripts/{dataset}/{dataset}_{model_size}_{identifier}_dedu_wscore.json', "w"), indent=4, ensure_ascii=False)
    ...
    df.to_csv(f"./{dataset}/{dataset}_{model_size}_{identifier}_dedu.csv")