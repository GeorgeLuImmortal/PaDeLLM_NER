...
if __name__ == "__main__":
    ...
    json.dump(test_data, open(f'./results/{dataset}_{model_size}_{identifier}_wscore.json', "w"), indent=4, ensure_ascii=False)
    ...
    df.to_csv(f"./results/{dataset}_{model_size}_{identifier}.csv")